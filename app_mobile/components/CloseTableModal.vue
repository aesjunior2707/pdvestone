      ...
      >
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-semibold text-gray-900">
            Fechar Mesa {{ itemsTable.table_id }}
          </h3>
          <button
            @click="$emit('close')"
      ...
      <div class="p-4">
        ...
        <div class="mb-6">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="font-medium"
                >R${{ group.totalPrice.toFixed(2) }}</span
              >
            </div>
          </div>
          ...
          <div class="flex justify-between items-center pt-2">
            <span class="text-base font-medium text-gray-700"
              >Taxa de serviço (10%)</span
            >
            <span class="text-base font-medium text-gray-700"
              >R${{ serviceCharge.toFixed(2) }}</span
            >
          </div>

          <!-- Final Total -->
          <div
            class="flex justify-between items-center pt-3 mt-3 border-t-2 border-gray-300"
          >
            <span class="text-lg font-bold text-gray-900">Total Final</span>
            <span class="text-lg font-bold text-emerald-600"
              >R${{ finalTotal.toFixed(2) }}</span
            >
          </div>
        </div>
        ...
        <div class="mb-6 space-y-3">
          <label class="flex items-center space-x-3">
            ...
            <span class="text-sm text-gray-700"
              >Imprimir recibo do cliente</span
            >
          </label>
